...
public class Utilisateur implements Serializable {
     ...
     * L'ID est initialisé à 0 car il sera généré par la base de données lors de l'insertion.
     */
    ...
    // Le setId() est crucial pour mettre à jour l'objet avec l'ID généré par la BDD après insertion.
     ...
     * En production, cette comparaison DOIT se faire sur les hachages des mots de passe.
     */
